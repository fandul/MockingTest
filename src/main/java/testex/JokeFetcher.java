...
public class JokeFetcher {
    ...
    public JokeFetcher (IDateFormatter formatter, IFetcherFactory factory) {
  ...
  /**
   * DO NOT TEST this function. It's included 
   * only to get a quick way of executing the code
   * @param args 
   */
